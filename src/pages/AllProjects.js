...
export default function AllProjects() {
    ...
    background-color: ${project => project.status === "Complete" ? "var(--main-green)" : project.status === "In Progress" ? "var(--main-yellow)" : "var(--main-dark-grey)"};
    color: black;
`;
        ...
        <div className="display-flex text-center ">
            ...
            <Container >
                <CardDeck className="mb-4 ">
                    {projects.map((project) =>  project.status === "Complete" ? (
                        ...
                        <StyledFooter status={project.status} className="project-card-footer" >
                                <Row>
                                    <h6 className="col-12 text-center">Completed</h6>
                                </Row>
                        </StyledFooter>
                    </Card>
                    ) : ( 
